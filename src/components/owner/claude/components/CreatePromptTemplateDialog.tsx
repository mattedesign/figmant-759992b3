...
interface CreatePromptTemplateDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
}

export const CreatePromptTemplateDialog: React.FC<CreatePromptTemplateDialogProps> = ({
  isOpen,
  onClose,
  onSuccess
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createPromptMutation.mutateAsync(templateData);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Create New Prompt Template</DialogTitle>
          <DialogDescription>
            Create a reusable prompt template with dynamic form fields for enhanced analysis
          </DialogDescription>
        </DialogHeader>
