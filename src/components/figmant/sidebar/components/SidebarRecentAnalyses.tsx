...
import { MessageSquare, FileText, Clock, ChevronDown, ChevronUp, ExternalLink, Grid } from 'lucide-react';
...
export const SidebarRecentAnalyses: React.FC<SidebarRecentAnalysesProps> = ({
  ...
  const handleViewAllAnalyses = () => {
    // Navigate to the all analyses page
    onSectionChange('all-analyses');
  };
