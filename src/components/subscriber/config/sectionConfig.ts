...
import { MessageSquare, Target, TrendingUp, Eye, FileText, Lightbulb, Crown, Plug } from 'lucide-react';
  ...
  workspace: {
    ...
    items: [
      { 
        ...
        icon: MessageSquare, 
        disabled: false,
        description: 'Universal analysis with all templates'
      },
      { 
      ...
      { id: 'prompts', label: 'Templates', icon: MessageSquare, disabled: false },
