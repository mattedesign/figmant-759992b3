...
import { Mail, Lock, User, Eye, EyeOff, Loader2, CheckCircle, ArrowRight } from 'lucide-react';

interface ModernSignUpFormProps {
  onSuccess: () => void;
}

export const ModernSignUpForm: React.FC<ModernSignUpFormProps> = ({ onSuccess }) => {
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`modern-input pl-10 ${errors.fullName ? 'border-destructive' : ''}`}
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className={`modern-input pl-10 pr-10 ${errors.confirmPassword ? 'border-destructive' : ''}`}
